...
class MShop_Customer_Manager_List_FosUserTest extends PHPUnit_Framework_TestCase
{
	private $object;
	private $context;
	private $editor = '';
	...
	protected function setUp()
	{
		...
		$manager = MShop_Customer_Manager_Factory::createManager( $this->context, 'FosUser' );
		$this->object = $manager->getSubManager( 'list', 'FosUser' );
	}
	...
	public function testAggregate()
	{
		...
		$expr = array(
			...
			$search->compare( '==', 'customer.list.editor', 'ai-symfony:unittest' ),
		);
